...
export default function PrivateSubnetFields({ nodeId }: { nodeId: string }) {
  ...
  return (
    <div>
      <div style={fieldStyle}>
        ...
        <input
          type="text"
          value={config.subnetCidr ?? '10.0.1.0/24'}
      ...
      >
        Private subnets have no direct internet route. Outbound traffic flows through a NAT Gateway
        in the public subnet. Place app servers, databases, and caches here.
        This is a visual container only — no simulation effect.
      </div>
    </div>
  );
}
